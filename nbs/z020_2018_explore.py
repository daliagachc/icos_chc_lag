...
# %%
    ...
    # %%
    F = '../data/CHC_cumbre_15M_2018 -01.txt'

    df = pd.read_csv(F,sep='\s+',skiprows=15)
...
def get_presL():
    F = '../data/CHC_ICOS_471_2018_01.dat'

    df = pd.read_csv(F,sep='\t')
    df['DT'] = pd.to_datetime(df['dateok'])
